...
class ProviderGenerator {
  ...
  static Future<void> createProviderFile(Schema schema) async {
    ...
    classContent += _getClearMethod(schema);
    classContent += END_OF_LINE;
  ...
  static Future<void> createProviderUtils(List<Schema> schemas) async {
    var import = '';
    var clearProviders = '';
    var changeNotifierProviders = '';
    for (var schema in schemas) {
      import += "import '${schema.metaData[DART_FILE_PREFIX]!}Provider.dart';$END_OF_LINE";
      clearProviders +=
...
$clearProviders
  	...
  	/** put this into the providers of MultiProvider in the App main
...
$changeNotifierProviders
    ...
    final targetPath = '${Directory.current.path}/lib/autoGenerated';
    await FileUtils.writeToFile(targetPath, 'ProviderUtils.dart', classContent);
  }
  ...
  static String _getClearMethod(Schema schema) {
    final className = schema.metaData[CLASS_NAME];
    var ret = '''
...
''';
  ...
  static String _getQueryPreloadedDataById(Schema schema) {
    final className = schema.metaData[CLASS_NAME];
    var ret = '';
    ret += '${TAB}${className}? queryPreloadedDataById(int id) {$END_OF_LINE';
    ret +=
...
''';
  ...
  static String _getMembers(Schema schema) {
    ...
    ret += '${TAB}List<${schema.metaData[CLASS_NAME]}>? _allData;$END_OF_LINE';
